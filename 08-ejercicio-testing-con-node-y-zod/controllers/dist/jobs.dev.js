      ...
      return regeneratorRuntime.async(function create$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return regeneratorRuntime.awrap(_job.JobModel.create(request.validatedBody));
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              id = request.params.id;
              _context4.next = 3;
              return regeneratorRuntime.awrap(_job.JobModel.update(id, request.validatedBody));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              id = request.params.id;
              _context5.next = 3;
              return regeneratorRuntime.awrap(_job.JobModel.partialUpdate(id, request.validatedBody));
