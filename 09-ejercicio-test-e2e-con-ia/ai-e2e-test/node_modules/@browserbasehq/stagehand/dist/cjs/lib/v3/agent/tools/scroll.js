...
exports.scrollVisionTool = exports.scrollTool = void 0;
 ...
 */
const scrollTool = (v3) => (0, ai_1.tool)({
    ...
    inputSchema: zod_1.z.object({
        ...
        percentage: zod_1.z.number().min(1).max(200).optional(),
    }),
 ...
 */
const scrollVisionTool = (v3, provider) => (0, ai_1.tool)({
    ...
    execute: async ({ direction, coordinates, percentage = 80, }) => {
        ...
        const deltaY = direction === "up" ? -scrollDistance : scrollDistance;
        await page.scroll(cx, cy, 0, deltaY);
        const screenshotBase64 = await (0, screenshotHandler_js_1.waitAndCaptureScreenshot)(page, 100);
        v3.recordAgentReplayStep({
            type: "scroll",
            deltaX: 0,
            deltaY,
...
exports.scrollVisionTool = scrollVisionTool;
