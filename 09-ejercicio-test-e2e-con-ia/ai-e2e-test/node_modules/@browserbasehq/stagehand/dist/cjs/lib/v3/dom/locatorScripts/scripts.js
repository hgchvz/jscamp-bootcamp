...
exports.ensureFileInputElement = ensureFileInputElement;
exports.assignFilePayloadsToInputElement = assignFilePayloadsToInputElement;
exports.dispatchDomClick = dispatchDomClick;
exports.scrollElementToPercent = scrollElementToPercent;
exports.prepareElementForTyping = prepareElementForTyping;
exports.fillElementValue = fillElementValue;
exports.focusElement = focusElement;
exports.selectElementOptions = selectElementOptions;
exports.isElementVisible = isElementVisible;
exports.isElementChecked = isElementChecked;
exports.readElementInputValue = readElementInputValue;
exports.readElementTextContent = readElementTextContent;
exports.readElementInnerHTML = readElementInnerHTML;
exports.readElementInnerText = readElementInnerText;
...
function assignFilePayloadsToInputElement(payloads) {
    try {
        const input = this;
        ...
        for (const payload of entries) {
            ...
            const lastModified = typeof payload.lastModified === "number"
...
function dispatchDomClick(options) {
    const opts = options ?? {};
    try {
...
function scrollElementToPercent(percent) {
...
function prepareElementForTyping() {
    try {
        const element = this;
...
function fillElementValue(rawValue) {
    const element = this;
    if (!element.isConnected) {
    ...
    try {
        const dispatchInputAndChange = (eventValue) => {
            let inputEvent;
...
function selectElementOptions(rawValues) {
    try {
...
function readElementInputValue() {
    try {
        const element = this;
        const tag = (element.tagName || "").toLowerCase();
...
function readElementTextContent() {
    try {
