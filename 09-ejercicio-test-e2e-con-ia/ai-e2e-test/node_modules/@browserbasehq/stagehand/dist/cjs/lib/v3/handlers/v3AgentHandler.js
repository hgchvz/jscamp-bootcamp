...
class V3AgentHandler {
    ...
    constructor(v3, logger, llmClient, executionModel, systemInstructions, mcpTools, mode, captchaAutoSolveEnabled) {
        this.v3 = v3;
        this.logger = logger;
    ...
    async ensureDone(state, model, messages, instruction, outputSchema, logger) {
        if (state.completed)
            return { messages };
        const doneResult = await (0, handleDoneToolCall_js_1.handleDoneToolCall)({
            model,
