...
exports.bindInstanceLogger = bindInstanceLogger;
exports.unbindInstanceLogger = unbindInstanceLogger;
exports.withInstanceLogContext = withInstanceLogContext;
exports.v3Logger = v3Logger;
...
const logContext = new node_async_hooks_1.AsyncLocalStorage();
