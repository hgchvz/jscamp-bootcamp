import type { ActOptions, ActResult, AvailableModel, Logger, AgentResult, Action, LoadState } from "../public/index.js";
...
export type AgentReplayStep = AgentReplayActStep | AgentReplayFillFormStep | AgentReplayGotoStep | AgentReplayScrollStep | AgentReplayWaitStep | AgentReplayNavBackStep | AgentReplayKeysStep | {
    type: string;
    [key: string]: unknown;
};
