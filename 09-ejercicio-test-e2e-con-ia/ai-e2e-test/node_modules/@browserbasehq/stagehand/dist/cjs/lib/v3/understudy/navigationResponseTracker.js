...
class NavigationResponseTracker {
    ...
    resolveResponse;
    responsePromise;
    pendingResponsesByLoader = new Map();
    ...
    onLoadingFinished(event) {
        if (!event || !event.requestId)
            return;
        if (event.requestId !== this.selectedRequestId)
            return;
...
exports.NavigationResponseTracker = NavigationResponseTracker;
//# sourceMappingURL=navigationResponseTracker.js.map