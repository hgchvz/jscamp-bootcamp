...
test_1.test.describe("Locator and Page click methods", () => {
    let v3;
    ...
    (0, test_1.test)("locator.click() performs single click by default", async () => {
        ...
        (0, test_1.expect)(initialCount).toBe("0");
        ...
        (0, test_1.expect)(newCount).toBe("1");
    });
    (0, test_1.test)("locator.click() with clickCount: 2 performs double-click", async () => {
        const page = v3.context.pages()[0];
        ...
        (0, test_1.expect)(initialCount).toBe("0");
        (0, test_1.expect)(initialDcCount).toBe("0");
        ...
        (0, test_1.expect)(newDcCount).toBe("1");
        ...
        (0, test_1.expect)(await clickDetailDisplay.inputValue()).toBe("2");
        (0, test_1.expect)(await dblClickDetailDisplay.inputValue()).toBe("2");
    });
    (0, test_1.test)("locator.click() with clickCount: 3 performs triple-click", async () => {
        const page = v3.context.pages()[0];
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/click-test/");
        // Wait for page to be fully loaded
        await page.waitForLoadState("domcontentloaded");
        ...
        const newCount = await countDisplay.inputValue();
        (0, test_1.expect)(newCount).toBe("3");
    });
    (0, test_1.test)("page.click() performs single click with coordinates", async () => {
        const page = v3.context.pages()[0];
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/click-test/");
        // Wait for page to be fully loaded
        await page.waitForLoadState("domcontentloaded");
    ...
    (0, test_1.test)("page.click() with clickCount: 2 performs double-click", async () => {
        const page = v3.context.pages()[0];
        await page.goto(doubleClickFixtureUrl);
        await page.waitForLoadState("domcontentloaded");
        const countDisplay = page.locator("#clickCount");
    ...
    (0, test_1.test)("page.click() with clickCount: 3 performs triple-click", async () => {
        const page = v3.context.pages()[0];
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/click-test/");
        // Wait for page to be fully loaded
        await page.waitForLoadState("domcontentloaded");
