...
test_1.test.describe("Locator.backendNodeId() - CDP DOM node ID", () => {
    let v3;
    ...
    (0, test_1.test)("returns a valid backend node ID for an element", async () => {
        ...
        (0, test_1.expect)(typeof nodeId).toBe("number");
        (0, test_1.expect)(nodeId).toBeGreaterThan(0);
    });
    (0, test_1.test)("returns different node IDs for different elements", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body>
        ...
        (0, test_1.expect)(nodeId1).not.toBe(nodeId2);
        (0, test_1.expect)(nodeId2).not.toBe(nodeId3);
        (0, test_1.expect)(nodeId1).not.toBe(nodeId3);
    });
    (0, test_1.test)("returns consistent node ID for the same element", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body>
        ...
        (0, test_1.expect)(nodeId1).toBe(nodeId2);
    });
    (0, test_1.test)("returns node ID for nested elements", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body>
            <div id="outer">
        ...
        (0, test_1.expect)(outerNodeId).toBeGreaterThan(0);
        (0, test_1.expect)(middleNodeId).toBeGreaterThan(0);
        (0, test_1.expect)(innerNodeId).toBeGreaterThan(0);
        (0, test_1.expect)(new Set([outerNodeId, middleNodeId, innerNodeId]).size).toBe(3);
    });
    (0, test_1.test)("returns node ID for elements with various attributes", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body>
    ...
    (0, test_1.test)("returns node ID for form elements", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body>
            <form>
        ...
        (0, test_1.expect)(emailNodeId).toBeGreaterThan(0);
        (0, test_1.expect)(textareaNodeId).toBeGreaterThan(0);
        (0, test_1.expect)(selectNodeId).toBeGreaterThan(0);
        (0, test_1.expect)(submitNodeId).toBeGreaterThan(0);
        // All should be unique
        const nodeIds = [emailNodeId, textareaNodeId, selectNodeId, submitNodeId];
        (0, test_1.expect)(new Set(nodeIds).size).toBe(4);
    });
    (0, test_1.test)("returns node ID for dynamically created elements", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body>
    ...
    (0, test_1.test)("returns node ID for elements with text selectors", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body>
...
//# sourceMappingURL=locator-backend-node-id.spec.js.map