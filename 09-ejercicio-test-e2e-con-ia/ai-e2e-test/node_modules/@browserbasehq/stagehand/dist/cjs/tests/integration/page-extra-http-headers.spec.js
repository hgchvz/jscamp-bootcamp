...
test_1.test.describe("page.setExtraHTTPHeaders", () => {
    let v3;
    ...
    (0, test_1.test)("applies headers to navigation requests", async () => {
        ...
        (0, test_1.expect)(headers["x-page-header"]).toBe("from-page");
    });
    (0, test_1.test)("updated headers replace previous ones", async () => {
        const ctx = v3.context;
        const page = await ctx.awaitActivePage();
        const internal = page;
        await internal.mainSession.send("Network.enable");
        ...
        (0, test_1.expect)(headers["x-second"]).toBe("yes");
        (0, test_1.expect)(headers["x-first"]).toBeUndefined();
    });
});
