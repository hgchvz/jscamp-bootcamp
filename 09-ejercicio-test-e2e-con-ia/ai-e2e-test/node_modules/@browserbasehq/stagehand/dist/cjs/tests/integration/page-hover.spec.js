...
test_1.test.describe("Page.hover() - mouse hover at coordinates", () => {
    let v3;
    ...
    (0, test_1.test)("hover triggers mouseover event at coordinates", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="margin: 0; padding: 0;">
            <div id="target" 
        ...
        (0, test_1.expect)(hovered).toBe(false);
        ...
        (0, test_1.expect)(hovered).toBe(true);
    });
    (0, test_1.test)("hover moves mouse without clicking", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="margin: 0; padding: 0;">
            <button id="btn" 
        ...
        (0, test_1.expect)(state.hovered).toBe(true);
        (0, test_1.expect)(state.clicked).toBe(false);
    });
    (0, test_1.test)("hover returns xpath when requested", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="margin: 0; padding: 0;">
    ...
    (0, test_1.test)("hover without returnXpath returns empty string", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="margin: 0; padding: 0;">
    ...
    (0, test_1.test)("hover triggers CSS :hover styles", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
        ...
        (0, test_1.expect)(bgColor).toBe("rgb(255, 0, 0)"); // red
        ...
        (0, test_1.expect)(bgColor).toBe("rgb(0, 128, 0)"); // green
    });
    (0, test_1.test)("multiple hovers move the mouse correctly", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="margin: 0; padding: 0;">
            <div id="box1" 
        ...
        (0, test_1.expect)(state.box1).toBe(true);
        (0, test_1.expect)(state.box2).toBe(false);
        // Move hover to box2
        ...
        (0, test_1.expect)(state.box1).toBe(false);
        (0, test_1.expect)(state.box2).toBe(true);
    });
});
//# sourceMappingURL=page-hover.spec.js.map