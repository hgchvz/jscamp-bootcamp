...
test_1.test.describe("Page.scroll() - mouse wheel scrolling", () => {
    let v3;
    ...
    (0, test_1.test)("scrolls page vertically with positive deltaY", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="height: 2000px;">
        ...
        (0, test_1.expect)(scrollY).toBe(0);
        ...
        (0, test_1.expect)(scrollY).toBeGreaterThan(0);
    });
    (0, test_1.test)("scrolls page horizontally with positive deltaX", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="width: 2000px; height: 600px;">
        ...
        (0, test_1.expect)(scrollX).toBe(0);
        ...
        (0, test_1.expect)(scrollX).toBeGreaterThan(0);
    });
    (0, test_1.test)("scrolls in both directions simultaneously", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="width: 2000px; height: 2000px;">
        ...
        (0, test_1.expect)(scrollPos.x).toBeGreaterThan(0);
        (0, test_1.expect)(scrollPos.y).toBeGreaterThan(0);
    });
    (0, test_1.test)("scrolls at specific coordinate on page", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="height: 2000px;">
    ...
    (0, test_1.test)("scrolls with large deltaY values", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="height: 5000px;">
        ...
        const scrollY = await page.evaluate(() => window.scrollY);
        (0, test_1.expect)(scrollY).toBeGreaterThan(500);
    });
    (0, test_1.test)("negative deltaY scrolls up", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="height: 2000px;">
            <div style="height: 500px; background: lightblue;">Top</div>
        ...
        (0, test_1.expect)(scrolledDown).toBeGreaterThan(0);
        // Now scroll up (negative delta)
        await page.scroll(640, 400, 0, -300);
        await page.evaluate(() => new Promise((r) => setTimeout(r, 200)));
        scrollY = await page.evaluate(() => window.scrollY);
        (0, test_1.expect)(scrollY).toBeLessThan(scrolledDown);
    });
    (0, test_1.test)("scroll returns xpath when requested", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="height: 2000px; margin: 0; padding: 0;">
        ...
        (0, test_1.expect)(typeof xpath).toBe("string");
        (0, test_1.expect)(xpath.length).toBeGreaterThan(0);
        // Xpath should reference the div or contain "target"
        (0, test_1.expect)(xpath.toLowerCase()).toMatch(/div|target/);
    });
    (0, test_1.test)("scroll without returnXpath returns empty string", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="height: 2000px;">
        ...
        (0, test_1.expect)(result).toBe("");
    });
    (0, test_1.test)("multiple sequential scrolls accumulate", async () => {
        const page = v3.context.pages()[0];
        await page.goto("data:text/html," +
            encodeURIComponent(`<!doctype html><html><body style="height: 3000px;">
        ...
        (0, test_1.expect)(after1).toBeGreaterThan(0);
        // Second scroll
        await page.scroll(640, 400, 0, 200);
        await page.evaluate(() => new Promise((r) => setTimeout(r, 200)));
        const after2 = await page.evaluate(() => window.scrollY);
        (0, test_1.expect)(after2).toBeGreaterThan(after1);
    });
});
//# sourceMappingURL=page-scroll.spec.js.map