...
export const clickAndHoldTool = (v3, provider) => tool({
    ...
    execute: async ({ describe, coordinates, duration }) => {
        try {
            ...
            const processed = processCoordinates(coordinates[0], coordinates[1], provider, v3);
            v3.logger({
                category: "agent",
            ...
            const [xpath] = await page.dragAndDrop(processed.x, processed.y, processed.x, processed.y, { delay: duration, returnXpath: shouldCollectXpath });
...
//# sourceMappingURL=clickAndHold.js.map