...
export const fillFormVisionTool = (v3, provider, variables) => {
...
- Search filters: multiple criteria inputs`,
        inputSchema: z.object({
            fields: z
                ...
                action: z
                    .string()
                    .describe("Description of the typing action, e.g. 'type foo into the bar field'"),
        ...
        execute: async ({ fields }) => {
            try {
                ...
                const processedFields = fields.map((field) => {
                    const processed = processCoordinates(field.coordinates.x, field.coordinates.y, provider, v3);
                    return {
                        ...field,
...
//# sourceMappingURL=fillFormVision.js.map