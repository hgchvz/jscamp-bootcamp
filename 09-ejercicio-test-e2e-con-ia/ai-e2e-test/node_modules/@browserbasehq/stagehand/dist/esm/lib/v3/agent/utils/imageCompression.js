 ...
 */
export function findItemsWithImages(items) {
 ...
 */
export function compressConversationImages(items, keepMostRecentCount = 2) {
 ...
 * @returns Array of indices where images were found
 */
export function findGoogleItemsWithImages(items) {
    const itemsWithImages = [];
    items.forEach((item, index) => {
        let hasImage = false;
 ...
 * @returns Array of indices where images were found
 */
export function findOpenAIItemsWithImages(items) {
    const itemsWithImages = [];
    items.forEach((item, index) => {
        let hasImage = false;
 ...
 * @returns Object with processed items
 */
export function compressOpenAIConversationImages(items, keepMostRecentCount = 2) {
 ...
 * @returns Object with processed items
 */
export function compressGoogleConversationImages(items, keepMostRecentCount = 2) {
