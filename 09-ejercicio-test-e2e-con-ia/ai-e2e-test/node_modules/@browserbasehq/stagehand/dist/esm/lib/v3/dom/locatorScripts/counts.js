...
export function countCssMatchesPrimary(selectorRaw) {
...
export function countCssMatchesPierce(selectorRaw) {
    const selector = String(selectorRaw ?? "").trim();
    if (!selector)
        return 0;
...
export function countTextMatches(rawNeedle) {
...
export function countXPathMatchesMainWorld(rawXp) {
