 ...
 */
export function ensureFileInputElement() {
    try {
...
export function assignFilePayloadsToInputElement(payloads) {
    try {
        const input = this;
...
export function dispatchDomClick(options) {
    const opts = options ?? {};
    try {
...
export function scrollElementToPercent(percent) {
...
export function prepareElementForTyping() {
    try {
        const element = this;
...
export function fillElementValue(rawValue) {
    const element = this;
    if (!element.isConnected) {
...
export function selectElementOptions(rawValues) {
    try {
...
export function isElementChecked() {
    try {
        const element = this;
        const tag = (element.tagName || "").toLowerCase();
        if (tag === "input") {
...
export function readElementInputValue() {
    try {
        const element = this;
        const tag = (element.tagName || "").toLowerCase();
...
export function readElementTextContent() {
    try {
...
export function readElementInnerHTML() {
    try {
...
export function readElementInnerText() {
    try {
        const element = this;
