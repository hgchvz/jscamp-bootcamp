 ...
 */
export function parseXPathSteps(input) {
...
export function evaluatePredicate(element, predicate) {
    switch (predicate.type) {
        ...
        case "attrEquals": {
            ...
            if (attr === null)
                return false;
            return (normalizeMaybe(attr, predicate.normalize) ===
...
export function applyPredicates(elements, predicates) {
