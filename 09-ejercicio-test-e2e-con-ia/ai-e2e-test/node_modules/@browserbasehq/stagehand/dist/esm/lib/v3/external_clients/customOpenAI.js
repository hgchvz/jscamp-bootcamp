...
import { CreateChatCompletionResponseError, ZodSchemaValidationError, } from "../types/public/sdkErrors.js";
export class CustomOpenAIClient extends LLMClient {
    ...
    async createChatCompletion({ options, retries = 3, logger, }) {
        ...
        if (options.response_model) {
            const schemaJson = JSON.stringify(toJsonSchema(options.response_model.schema), null, 2);
        ...
        if (options.response_model) {
            ...
            try {
                ...
                throw new CreateChatCompletionResponseError(isParseError
...
//# sourceMappingURL=customOpenAI.js.map