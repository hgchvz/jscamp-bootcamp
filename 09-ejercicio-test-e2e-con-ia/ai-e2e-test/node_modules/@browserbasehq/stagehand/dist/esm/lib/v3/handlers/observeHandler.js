...
export class ObserveHandler {
    ...
    async observe(params) {
        ...
        this.onMetrics?.(V3FunctionName.OBSERVE, prompt_tokens, completion_tokens, reasoning_tokens, cached_input_tokens, inference_time_ms);
