...
import { validateZodSchema, toGeminiSchema, loadApiKeyFromEnv, } from "../../utils.js";
import { LLMClient, AnnotatedScreenshotText, } from "./LLMClient.js";
...
export class GoogleClient extends LLMClient {
    ...
    options, logger, retries = 3, }) {
        ...
        try {
            ...
            const toolCalls = result.functionCalls?.map((fc, index) => ({
