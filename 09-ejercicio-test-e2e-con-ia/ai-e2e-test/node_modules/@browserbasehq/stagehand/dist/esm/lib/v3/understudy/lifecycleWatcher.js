...
import { DEFAULT_IDLE_WAIT, IGNORED_RESOURCE_TYPES, } from "../types/private/network.js";
/**
...
export class LifecycleWatcher {
    ...
    async wait() {
        ...
        try {
            if (this.waitUntil === "domcontentloaded") {
                await this.awaitWithAbort(this.page.waitForMainLoadState("domcontentloaded", this.timeRemaining(deadline)));
                return;
            }
            while (true) {
                await this.awaitWithAbort(this.page.waitForMainLoadState("load", this.timeRemaining(deadline)));
    ...
    async awaitWithAbort(operation) {
        try {
    ...
    buildIdleFilter() {
        ...
        const mainFrameId = this.page.mainFrameId();
        return (info) => {
            if (IGNORED_RESOURCE_TYPES.has(info.resourceType))
                return false;
