...
test.describe("V3 default page tracking", () => {
    ...
    test("popup default-page flow via five-tab site", async () => {
        ...
        await root.goto("https://browserbase.github.io/stagehand-eval-sites/sites/five-tab/", { waitUntil: "load", timeoutMs: 15000 });
        ...
        expect(page2.url()).toBe("https://browserbase.github.io/stagehand-eval-sites/sites/five-tab/page2.html");
        ...
        expect(page3.url()).toBe("https://browserbase.github.io/stagehand-eval-sites/sites/five-tab/page3.html");
        // 4) Close the current page (page3) and ensure the default page reverts to page2
        await page3.close();
        const backToPage2 = await ctx.awaitActivePage();
        expect(backToPage2.url()).toBe("https://browserbase.github.io/stagehand-eval-sites/sites/five-tab/page2.html");
    });
});
//# sourceMappingURL=default-page-tracking.spec.js.map