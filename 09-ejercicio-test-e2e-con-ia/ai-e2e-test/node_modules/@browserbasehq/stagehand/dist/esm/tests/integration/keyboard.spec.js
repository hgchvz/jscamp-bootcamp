...
test.describe("V3 keyboard shortcuts and typing", () => {
    ...
    test("typing, select-all + delete clears input (Cmd maps cross-OS)", async () => {
      ...
      <input id="i1" autofocus />`;
        ...
        const value = await page.evaluate((sel) => document.querySelector(sel).value, "#i1");
        expect(value).toBe("");
    });
    test("accelerator does not inject printable text (Cmd+B does not type 'b')", async () => {
      ...
      <input id="i" />`;
        ...
        const value = await page.evaluate((sel) => document.querySelector(sel).value, "#i");
    ...
    test("cut clears the field (Cmd+X)", async () => {
      ...
      <input id="t" />`;
        ...
        const value = await page.evaluate((sel) => document.querySelector(sel).value, "#t");
        expect(value).toBe("");
    });
    ...
    test("Enter inserts newline in textarea", async () => {
      ...
      <textarea id="ta"></textarea>`;
        ...
        await page.keyPress("b");
        const value = await page.evaluate((sel) => document.querySelector(sel).value, "#ta");
        expect(value).toBe("a\nb");
    });
    ...
    test("Enter submits form from text input", async () => {
      ...
      <script>
        ...
        await page.type("foo");
        await page.keyPress("Enter");
        const submitted = await page.evaluate(() => document.getElementById("submitted")?.value || "");
