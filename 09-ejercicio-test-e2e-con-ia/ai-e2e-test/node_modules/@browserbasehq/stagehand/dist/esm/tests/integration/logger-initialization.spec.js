...
import { bindInstanceLogger, unbindInstanceLogger, withInstanceLogContext, v3Logger, } from "../../lib/v3/logger.js";
...
test.describe("V3 Logger with External Logger (Production Pattern)", () => {
    ...
    test("StagehandLogger wrapper forwards to external logger", () => {
        ...
        try {
            ...
            expect(externalLogs[0].message).toBe("Log through StagehandLogger wrapper");
        }
        finally {
            unbindInstanceLogger(instanceId);
        }
