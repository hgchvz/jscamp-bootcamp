...
test.describe("Page console events", () => {
    ...
    test("captures console messages emitted by the page", async () => {
        ...
        expect(received.some((m) => m.type === "error" && m.text.includes("error"))).toBeTruthy();
    });
});
