...
test.describe("Page sendCDP method", () => {
    ...
    test("sends CDP commands and requires domain to be enabled first", async () => {
        ...
        await expect(page.sendCDP("WebAuthn.addVirtualAuthenticator", {
            options: {
                protocol: "ctap2",
                transport: "usb",
