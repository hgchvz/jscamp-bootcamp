...
test.describe("tests performUnderstudyMethod", () => {
    ...
    test("tests that clicking works", async () => {
        ...
        await performUnderstudyMethod(page, page.mainFrame(), "click", "/html/body/button", [], 30000);
    ...
    test("fill sets input value", async () => {
        ...
        await performUnderstudyMethod(page, page.mainFrame(), "fill", "/html/body/main/form/div[1]/input", ["Alice"], 30000);
    ...
    test("tests that key presses work", async () => {
        ...
        await performUnderstudyMethod(page, page.mainFrame(), "press", "xpath=/html", ["Enter"], 30000);
        const textContent = await page
    ...
    test("tests select option from a dropdown", async () => {
        ...
        await performUnderstudyMethod(page, page.mainFrame(), "selectOptionFromDropdown", "xpath=//*[@id='licenseType']", ["Smog Check Technician"], 30000);
    ...
    test("tests drag & drop works (start xpath & end xpath)", async () => {
        ...
        await performUnderstudyMethod(page, page.mainFrame(), "dragAndDrop", "xpath=/html/body/div/section[1]/div[1]/div[1]", // start xpath
