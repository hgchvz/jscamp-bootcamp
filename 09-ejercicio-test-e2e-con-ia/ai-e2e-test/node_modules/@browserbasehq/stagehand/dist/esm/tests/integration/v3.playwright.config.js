...
const localWorkerOverride = Number(process.env.LOCAL_SESSION_LIMIT_PER_E2E_TEST);
const localWorkers = Number.isFinite(localWorkerOverride) && localWorkerOverride > 0
    ? localWorkerOverride
    : process.env.CI
        ? 3
        : 5;
const ciWorkerOverride = Number(process.env.BROWSERBASE_SESSION_LIMIT_PER_E2E_TEST);
const bbWorkers = process.env.CI && Number.isFinite(ciWorkerOverride) && ciWorkerOverride > 0
    ? ciWorkerOverride
    : 3;
...
//# sourceMappingURL=v3.playwright.config.js.map