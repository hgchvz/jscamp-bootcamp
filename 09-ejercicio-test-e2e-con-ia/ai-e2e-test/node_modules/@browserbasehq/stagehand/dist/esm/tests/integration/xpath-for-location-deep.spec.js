...
test.describe("resolveNodeForLocationDeep", () => {
    ...
    test("click resolves inside same-process iframe and returns absolute XPath", async () => {
        ...
        await page.goto("https://browserbase.github.io/stagehand-eval-sites/sites/iframe-hn/", { waitUntil: "networkidle" });
        await page.waitForSelector("section iframe", {
            state: "attached",
            timeout: 10000,
        });
        const frame = await page.frameLocator("section iframe").resolveFrame();
        await executionContexts.waitForMainWorld(frame.session, frame.frameId, 5000);
        ...
        const linkOffsetInFrame = await frame.evaluate(() => {
            ...
            const table = document.querySelector("center > table > tbody > tr:nth-child(3) > td > table");
            if (!table)
                return null;
        ...
        const x = iframeOffset && linkOffsetInFrame
            ? iframeOffset.left + linkOffsetInFrame.x
            : 356;
        const y = iframeOffset && linkOffsetInFrame
        ...
        expect(xpath).toBe("/html[1]/body[1]/main[1]/section[3]/iframe[1]/html[1]/body[1]/center[1]/table[1]/tbody[1]/tr[3]/td[1]/table[1]/tbody[1]/tr[88]/td[3]/span[1]/a[1]");
    });
});
//# sourceMappingURL=xpath-for-location-deep.spec.js.map