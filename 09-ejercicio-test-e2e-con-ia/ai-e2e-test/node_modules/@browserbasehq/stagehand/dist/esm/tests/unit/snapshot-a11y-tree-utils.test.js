...
import { buildHierarchicalTree, decorateRoles, extractUrlFromAXNode, isStructural, removeRedundantStaticTextChildren, } from "../../lib/v3/understudy/a11y/snapshot/a11yTree.js";
...
describe("removeRedundantStaticTextChildren", () => {
    ...
    it("keeps static text when combined text differs", () => {
        ...
        expect(removeRedundantStaticTextChildren(parent, children)).toEqual(children);
    });
...
describe("extractUrlFromAXNode", () => {
    ...
    it("returns undefined when url property missing or invalid", () => {
        expect(extractUrlFromAXNode(makeAxNode({ properties: [] }))).toBeUndefined();
        expect(extractUrlFromAXNode(makeAxNode({
