...
import { buildXPathFromSteps, IFRAME_STEP_RE, listChildrenOf, parseXPathToSteps, } from "../../lib/v3/understudy/a11y/snapshot/focusSelectors.js";
...
describe("parseXPathToSteps — frameset XPaths", () => {
    it("parses a frameset page XPath with frame[N] steps", () => {
        const steps = parseXPathToSteps("/html[1]/frameset[1]/frame[4]/html[1]/body[1]/table[1]");
        expect(steps).toEqual([
    ...
    it("detects iframe boundaries in standard iframe XPaths", () => {
        const steps = parseXPathToSteps("/html[1]/body[1]/div[2]/iframe[1]/html[1]/body[1]/p[1]");
        const frameBoundaries = steps.filter((s) => IFRAME_STEP_RE.test(s.name));
        expect(frameBoundaries).toHaveLength(1);
...
//# sourceMappingURL=snapshot-focus-selectors-utils.test.js.map