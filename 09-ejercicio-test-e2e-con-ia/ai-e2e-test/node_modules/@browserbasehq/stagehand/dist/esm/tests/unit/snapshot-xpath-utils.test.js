...
import { buildChildXPathSegments, joinXPath, normalizeXPath, prefixXPath, } from "../../lib/v3/understudy/a11y/snapshot/xpathUtils.js";
...
describe("relativizeXPath", () => {
    ...
    it("omits duplicate prefixes and preserves descendant hops", () => {
        ...
        expect(relativizeXPath("/html/body", "/html/body//shadow-root[1]")).toBe("//shadow-root[1]");
    });
