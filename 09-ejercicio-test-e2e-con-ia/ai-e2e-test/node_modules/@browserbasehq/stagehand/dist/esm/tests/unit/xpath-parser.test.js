...
import { applyPredicates, parseXPathSteps, } from "../../lib/v3/dom/locatorScripts/xpathParser.js";
describe("parseXPathSteps", () => {
    ...
    describe("text predicates", () => {
        ...
        it("parses normalize-space on text", () => {
            const steps = parseXPathSteps("//div[normalize-space(text())='Hello world']");
            expect(steps[0].predicates).toEqual([
    ...
    describe("multi-step with predicates", () => {
        it("parses complex path with mixed predicates", () => {
            const steps = parseXPathSteps("/html/body//div[@class='container']/ul/li[3]");
            expect(steps).toEqual([
                { axis: "child", tag: "html", predicates: [] },
                { axis: "child", tag: "body", predicates: [] },
                {
    ...
    describe("edge cases", () => {
        ...
        it("handles URL attribute values with multiple slashes", () => {
            const steps = parseXPathSteps("//a[@data-url='http://example.com/path/to/page']");
            expect(steps).toEqual([
                {
                    axis: "desc",
                    tag: "a",
...
//# sourceMappingURL=xpath-parser.test.js.map